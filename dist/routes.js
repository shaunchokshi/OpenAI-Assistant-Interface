...
async function registerRoutes(app) {
  ...
  setupAuth(app);
  app.get("/api/user/sessions", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.delete("/api/user/sessions/:id", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.delete("/api/user/sessions", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.get("/api/user/config", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.post("/api/settings/apikey", ensureAuthenticated2, async (req, res) => {
    try {
  ...
  app.post("/api/settings/default-assistant", ensureAuthenticated2, async (req, res) => {
    try {
  ...
  app.get("/api/settings/preferences", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.post("/api/settings/preferences", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.get("/api/assistants", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.get("/api/assistants/:id", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.post("/api/assistants", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.patch("/api/assistants/:id", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.delete("/api/assistants/:id", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.get("/api/threads", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.get("/api/threads/:id/messages", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.patch("/api/threads/:id", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.delete("/api/threads/:id", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.post("/api/thread/new", ensureAuthenticated2, initThread);
  app.post("/api/chat", ensureAuthenticated2, chatWithAssistant);
  app.post("/api/upload", ensureAuthenticated2, uploadFiles);
  app.post("/api/upload-directory", ensureAuthenticated2, uploadFiles);
  app.get("/api/files", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.post("/api/files/upload", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.delete("/api/files/:id", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.get("/api/analytics/usage", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.get("/api/analytics/summary", ensureAuthenticated2, async (req, res) => {
    try {
      if (!req.user?.id) {
        return res.status(401).json({ error: "User not authenticated" });
      }
  ...
  app.get("/api/fine-tuning/models", ensureAuthenticated2, getFineTunableModels);
  app.post("/api/fine-tuning/jobs", ensureAuthenticated2, createFineTuningJob);
  app.get("/api/fine-tuning/jobs", ensureAuthenticated2, getUserFineTuningJobs);
  app.get("/api/fine-tuning/jobs/:id", ensureAuthenticated2, getFineTuningJobDetails);
  app.post("/api/fine-tuning/jobs/:id/cancel", ensureAuthenticated2, cancelFineTuningJob);
  app.get("/api/fine-tuning/models/custom", ensureAuthenticated2, getUserFineTunedModels);
  app.patch("/api/fine-tuning/models/custom/:id", ensureAuthenticated2, updateFineTunedModelStatus);
  app.delete("/api/fine-tuning/models/custom/:id", ensureAuthenticated2, deleteFineTunedModel);
